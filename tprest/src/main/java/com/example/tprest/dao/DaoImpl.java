package com.example.tprest.dao;
...
public class DaoImpl implements IDao {
    // Liste modifiable
    private static final List<Article> database = new ArrayList<>(Arrays.asList(
    ...
    @Override
    public List<Article> findAll() { return database; }
    @Override
    public void save(Article article) { database.add(article); }
    @Override
